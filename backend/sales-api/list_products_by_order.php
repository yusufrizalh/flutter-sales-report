...
$stmt = $db->prepare("SELECT c.cashier_name, cus.customer_name, o.order_id, o.order_date, p.product_name, p.product_price, d.product_qty, (p.product_price * d.product_qty) subtotal
